...
function AuthedLayout() {
  ...
  return (
    <div className="dark relative isolate min-h-app pb-28 md:pb-8 text-foreground">
      ...
      <div className="relative z-10 transition-[padding] duration-300 md:pl-[calc(var(--sidenav-width,15rem)+1.5rem)] md:[--safe-top:0px] [--safe-top:env(safe-area-inset-top)] [padding-top:var(--safe-top)]">
        <Outlet />
      </div>
